...
(function () {
  ...
  // "Download App" nav button — scrolls to store badges on index, links there from other pages
  const downloadHref = (currentPath === 'index.html' || currentPath === '') ? '#download' : 'index.html#download';
...
<header class="site-header">
  <div class="container">
    ...
    <nav class="site-nav" id="site-nav" aria-label="Main navigation">
      ...
      <a href="${downloadHref}" class="btn-download">Download App</a>
    </nav>
